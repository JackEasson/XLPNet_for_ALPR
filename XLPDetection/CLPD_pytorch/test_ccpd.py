...
from data_loader.datasets import BBOXCCPDDataSet2019
...
def test(args):
    ...
    if not args.split_mode:
        ...
        # [1] datasets
        dataset_test = BBOXCCPDDataSet2019(folder=cfg.CCPD2019['root'], data_txt_path=cfg.CCPD2019['test_txt'],
        ...
        with torch.no_grad():
            ...
            for step, (images_tensor, corners_tensor_list, bboxes_tensor_list, img_name_list) in enumerate(pbar):
                ...
                for batch_idx in range(cur_batch_size):
                    ...
                    gt_bbox_list.append(bboxes_tensor_single)
                    n_gt += bboxes_tensor_single.size(0)
        ...
        for subset in split_list:
            ...
            # [1] datasets
            dataset_test = BBOXCCPDDataSet2019(folder=cfg.CCPD2019['root'],
                                               data_txt_path=os.path.join(cfg.CCPD2019['root'], "splits", subset),
                                               inp_size=(cfg.INP_SIZE, cfg.INP_SIZE),
                                               use_letterbox=cfg.USE_LETTER_BOX,
                                               limit=-1)
            loader_test = DataLoader(dataset_test, num_workers=args.workers, batch_size=args.batch_size,
                                     drop_last=False, shuffle=False, collate_fn=dataset_test.base_collate_fn)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--split_mode', type=bool, default=False)
    parser.add_argument('--weight', default="./output/effS_0309/model_25_out.pth")
