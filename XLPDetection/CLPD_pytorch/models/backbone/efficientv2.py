...
class ConvBNAct(nn.Module):
    def __init__(self,
        ...
        if activation_layer is None:
            ...
            # ============== change SiLU to HardSwish for ONNX ============
...
def efficientnetv2_lite():
    ...
    model_config = [[1, 3, 1, 1, 24, 32, 0, 0],
                    [2, 3, 2, 1, 32, 64, 0, 0],
                    [2, 5, 2, 2, 64, 96, 1, 0],
                    [2, 5, 2, 2, 96, 160, 1, 0],
                    [2, 5, 2, 2, 160, 196, 1, 0]]
...
if __name__ == '__main__':
    model = efficientnetv2_lite().eval()
